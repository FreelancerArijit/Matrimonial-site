...
<div class="container-fluid p-3 m-auto justify-content-center align-items-center">
  <div class="container-fluid"> <h3 class="text-center">Success stories</h3> </div>
...
<div class="card m-3 hover-scale" style="width: 18rem; cursor: pointer;" id="cards-container">
  <img src="./images/cardimg1.jpg" class="card-img-top image-fluid w-100 mx-auto" style="height: 250px;" alt="...">
  <div class="card-body">
...
<div class="card m-3 hover-scale" style="width: 18rem; cursor: pointer;" id="cards-container">
<img src="./images/cardimg2.jpg" class="card-img-top image-fluid w-100 mx-auto" style="height: 250px;" alt="...">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="blog.php" class="btn btn-primary" style="background-color: #c00745; border: none; ">View More</a>
...
<div class="card m-3 hover-scale" style="width: 18rem; cursor: pointer;" id="cards-container">
<img src="./images/cardimg3.jpg" class="card-img-top image-fluid w-100 mx-auto" style="height: 250px;" alt="...">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="blog.php" class="btn btn-primary" style="background-color: #c00745; border: none; ">View More</a>
...
<div class="card m-3 hover-scale" style="width: 18rem; cursor: pointer;" id="cards-container">
<img src="./images/cardimg4.jpg" class="card-img-top image-fluid w-100 mx-auto" style="height: 250px;" alt="...">
   <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="blog.php" class="btn btn-primary" style="background-color: #c00745; border: none; ">View More</a>
