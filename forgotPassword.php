        ...
        <div class="login-container">         
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="conpass" name="password" placeholder="Enter new password again" required>
                </div>

                <button id= "user-login" type="submit" class="btn btn-block text-white" style="background-color: #c00745; border: none;">Change password</button>
...
<div class="container-fluid mt-auto position-relative" style="background-color: #c00745; top: 6%; ">
