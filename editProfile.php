    ...
    <form method="POST" novalidate>
     ...
     <div class="form-group col-6">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Ronit Roy" id="name" name="name"  aria-describedby="nameHelp">
      </div>

      <div class="form-group">
        <label for="age" class="form-label">Age</label>
        <input type="number" placeholder="26" class="form-control" id="age" name="age"  aria-describedby="nameHelp">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="mobile" name="mobile"  aria-describedby="mobileHelp" placeholder="+91 7865095896">
      </div>

      <!-- Email -->
      <div class="form-group">
        <label for="email" class="form-label">Email address</label>
        <input type="email" class="form-control" placeholder="abc@gmail.com" id="email" name="email"  aria-describedby="emailHelp">
      </div>
      ...
      <fieldset class="form-group">
        ...
        <div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="Siblings" id="" value="yes" >
            <label class="form-check-label" for="yes">Yes</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="Siblings" id="" value="no" >
      ...
      <div class="form-group">
        ...
        <input type="text" placeholder="Kolkata" class="form-control" id="lives_in" name="lives_in"  aria-describedby="nameHelp">
      </div>

      <div class="form-group">
        <label for="hometown" class="form-label">Home town</label>
        <input type="text" placeholder="Malda" class="form-control" id="hometown" name="hometown"  aria-describedby="nameHelp">
      </div>

       <div class="form-group">
        <label for="district" class="form-label">District</label>
        <input type="text" placeholder="Hooghly" class="form-control" id="dist" name="dist"  aria-describedby="nameHelp">
      </div>

      <div class="form-group">
        <label for="state" class="form-label">State</label>
        <input type="text" placeholder="West Bengal" class="form-control" id="state" name="state"  aria-describedby="nameHelp">
      </div>
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <input type="text" placeholder="Bengali" class="form-control" id="mothertounge" name="mothertounge"  aria-describedby="nameHelp">
      </div>

      <div class="form-group">
        <label for="height" class="form-label">Height</label>
        <input type="number" placeholder="5.7" class="form-control" id="height" name="height"  aria-describedby="nameHelp">
      </div>

      <div class="form-group">
        <label for="weight" class="form-label">Weight</label>
        <input type="number" placeholder="67" class="form-control" id="weight" name="weight"  aria-describedby="nameHelp">
      </div>
      ...
      <fieldset class="form-group">
        ...
        <div>
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="skintone" id="" value="Other" >
      ...
      <div class="form-group">
        ...
        <input type="text" placeholder="Engineering" class="form-control" id="edu" name="edu"  aria-describedby="nameHelp">
      </div>

       <div class="form-group">
        <label for="occu" class="form-label">Occupation</label>
        <input type="text" placeholder="Software Engineer" class="form-control" id="occu" name="occu"  aria-describedby="nameHelp">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Ranjit Roy" id="fname" name="fname"  aria-describedby="nameHelp">
      </div>

      <!-- father occupation -->
      <div class="form-group">
        <label for="foccupation" class="form-label">Father's occupation</label>
        <input type="text" class="form-control" placeholder="Jobs" id="foccu" name="foccu"  aria-describedby="nameHelp">
      </div>

       <!-- mother Name -->
      <div class="form-group">
        <label for="mname" class="form-label">Mothers's name</label>
        <input type="text" class="form-control" placeholder="Rani Roy" id="mname" name="mname"  aria-describedby="nameHelp">
      </div>

        <!-- mothers occupation -->
      <div class="form-group">
        <label for="moccupation" class="form-label">Mother's occupation</label>
        <input type="text" class="form-control" placeholder="Housewife" id="moccu" name="moccu"  aria-describedby="nameHelp">
      </div>
